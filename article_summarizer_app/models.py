...
class NewsArticle(models.Model):
    ...
    medium_top_summary = models.TextField()
    long_top_summary = models.TextField()
    medium_block_summary = models.TextField(null=True)
    long_block_summary = models.TextField(null=True)